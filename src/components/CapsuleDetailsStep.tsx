    ...
    <div className="space-y-6" id="capsule-details-step-wrapper">
        ...
        <div className="flex flex-col sm:flex-row items-stretch gap-3">
          <div className="relative flex-grow">
            ...
            <input
              ...
              value={walletAddress}
              className="block w-full pl-10 pr-4 py-3 bg-[#0A0F24]/50 border border-[#D4AF37]/10 rounded-lg text-xs font-mono text-gray-400 focus:outline-none cursor-not-allowed select-all"
          ...
          <div className="flex-shrink-0 flex items-center">
            <WalletConnectButton 
              ...
              className="py-3 h-full px-5 text-xs font-mono"
            />
          </div>
        </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="block w-full px-4 py-3 bg-[#0A0F24]/80 border border-[#D4AF37]/15 rounded-lg text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:border-[#D4AF37]/60 resize-none font-light"
