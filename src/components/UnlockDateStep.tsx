    ...
    <div className="space-y-6" id="unlock-date-step-wrapper">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-4 py-3 bg-[#0A0F24]/80 border border-[#D4AF37]/15 rounded-lg text-sm text-gray-200 focus:outline-[#D4AF37]/40 font-mono tracking-wider"
      ...
      <div className="p-5 bg-[#0A0F24]/40 rounded-xl border border-gray-800 flex items-start gap-3">
        ...
        <div className="text-left space-y-1">
          <span className="block text-xs font-mono text-gray-300 uppercase tracking-wider">Time-Locked Consensus Cryptography</span>
